...
export const useSetDigimonItems = () => {
    const SetDigimonItems: (fetchDigiData: Promise<digimons | undefined>, setDigimonData: React.Dispatch<React.SetStateAction<digimons | undefined>>, setDescriptions: React.Dispatch<React.SetStateAction<string>>, setNextEvolutions: React.Dispatch<React.SetStateAction<evolutions[]>>, setPriorEvolutions: React.Dispatch<React.SetStateAction<evolutions[]>>, setType: React.Dispatch<React.SetStateAction<string[]>>) => void = (
